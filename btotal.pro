...
openu, lun, "decaydata.dat", /GET_LUN, /APPEND
printf, lun, format='(%"%s\t%f\t%f\t%f\t%f\t%f\t%f\t%s")', justdate, longitude, latitude, leadingb, leadingnum, $
trailingb, trailingnum, 'Leading'
free_lun, lun
...
openu, lun, "decaydata.dat", /GET_LUN, /APPEND
printf, lun, format='(%"%s\t%f\t%f\t%f\t%f\t%f\t%f\t%s")', justdate, longitude, latitude, leadingb, leadingnum, $
trailingb, trailingnum, 'Trailing'
free_lun, lun
